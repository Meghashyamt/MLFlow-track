...
if __name__ == "__main__":
    ...
    max_features=int(sys.argv[2]) if len(sys.argv) > 1 else 5
    n_estimators=int(sys.argv[3]) if len(sys.argv) > 1 else 10
    ...
    with mlflow.start_run():
        ...
        if tracking_url_type_store != "file":
            ...
            mlflow.sklearn.log_model(lr, "model", registered_model_name="RFmodel")
        else:
